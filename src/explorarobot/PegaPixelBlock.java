        ...
        try {
            ...
            for (int i = 0; i < BLOCK_Y; i++) {
                for (int j = 0; j < BLOCK_X; j++) {
                    ...
                    System.out.print("(" + cor.getRed() + " " + cor.getGreen() + " " + cor.getBlue() + ")");
                    //buffer[aux++] = (byte) ((bi.getRGB(i, j) & 0xFF000000) >> 24); // Transparencia, modificar para x 4 o tamanhodo buffer
